// Package webscreenshots provides a Go client for the Website Screenshot API.
//
// For more information, visit: https://webscreenshots.apiverve.com?utm_source=go&utm_medium=readme
...
// Request contains the parameters for the Website Screenshot API.
//
// Parameters:
//   - url (required): string - The URL of the web page to capture the screenshot (e.g., https://example.com) [format: url]
//   - type: string - The image format for the screenshot
//   - width: number - The width of the screenshot in pixels (e.g., 1920). Must be between 100 and 3840 [min: 100, max: 3840]
//   - height: number - The height of the screenshot in pixels (e.g., 1080).  Must be between 100 and 3840 [min: 100, max: 3840]
//   - fullpage: boolean - Whether to capture the full page screenshot (true or false)
type Request struct {
	Url string `json:"url"` // Required
	Type string `json:"type,omitempty"` // Optional
	Width int `json:"width,omitempty"` // Optional
	Height int `json:"height,omitempty"` // Optional
	Fullpage bool `json:"fullpage,omitempty"` // Optional
}
...
func (r *Request) Validate() error {
	rules := map[string]ValidationRule{
		...
		"width": {Type: "number", Required: false, Min: float64Ptr(100), Max: float64Ptr(3840)},
		"height": {Type: "number", Required: false, Min: float64Ptr(100), Max: float64Ptr(3840)},
...
// ResponseData contains the data returned by the Website Screenshot API.
