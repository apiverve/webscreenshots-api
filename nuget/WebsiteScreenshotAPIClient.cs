...
namespace APIVerve.API.WebsiteScreenshot
{
    ...
    /// <summary>
    /// Client for the WebsiteScreenshot API
    /// </summary>
...
#endif
    {
        ...
        private static readonly Dictionary<string, ValidationRule> _validationRules = new Dictionary<string, ValidationRule>
        {
            ...
            { "width", new ValidationRule { Type = "number", Required = false, Min = 100, Max = 3840 } },
            { "height", new ValidationRule { Type = "number", Required = false, Min = 100, Max = 3840 } },
            { "fullpage", new ValidationRule { Type = "boolean", Required = false } }
        };
        ...
        public WebsiteScreenshotAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public WebsiteScreenshotAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public WebsiteScreenshotAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        private void ValidateParams(WebsiteScreenshotQueryOptions options)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(WebsiteScreenshotQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(WebsiteScreenshotQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(WebsiteScreenshotQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(WebsiteScreenshotQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(WebsiteScreenshotQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
