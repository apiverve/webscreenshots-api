# Website Screenshot Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:webscreenshots-api:1.1.12'
}
```
...
```java
import com.apiverve.webscreenshots.WebsiteScreenshotAPIClient;
import com.apiverve.webscreenshots.APIResponse;
import com.apiverve.webscreenshots.APIException;

// Initialize the client
WebsiteScreenshotAPIClient client = new WebsiteScreenshotAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/webscreenshots](https://docs.apiverve.com/ref/webscreenshots)
...
- **Documentation:** [https://docs.apiverve.com/ref/webscreenshots](https://docs.apiverve.com/ref/webscreenshots)
- **Issues:** [GitHub Issues](https://github.com/apiverve/webscreenshots-api/issues)
